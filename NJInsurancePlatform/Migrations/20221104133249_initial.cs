    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AccountManagerMUID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccountManagers", x => x.AccountManagerMUID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Active = table.Column<bool>(type: "bit", nullable: false),
                    AccountManagerMUID = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers", x => x.CustomerMUID);
                    table.ForeignKey(
                        name: "FK_Customers_AccountManagers_AccountManagerMUID",
                        column: x => x.AccountManagerMUID,
                        principalTable: "AccountManagers",
                        principalColumn: "AccountManagerMUID");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "1b2410c2-0329-4dbb-865e-2771d9e79ba8", "0c469e68-ce8e-4686-9335-edc4ea1fd28e", "Customer", "CUSTOMER" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "965996ac-d2d9-4e27-9b6c-74c48b2c30b6", "e1227a79-a8c7-4cbd-abb3-9a898bf136c6", "Admin", "ADMIN" });

            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { "ef0d9874-a609-41e8-bf98-9658520418ee", "3ee02a0a-eee9-4e9c-aca7-9d79ba678076", "Guest", "GUEST" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_AccountManagerMUID",
                table: "Customers",
                column: "AccountManagerMUID");
        }
